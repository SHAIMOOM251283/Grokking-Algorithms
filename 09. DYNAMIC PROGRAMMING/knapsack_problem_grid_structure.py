def knapsack(items, capacity):
    ...
    # Iterate over each possible weight capacity of the knapsack (changing from row-wise to column-wise)
    for w in range(1, capacity + 1):
        ...
        for i in range(1, n + 1):
            ...
            if items[i - 1][2] > w:
                ...
                # At this point, dp[i][w] represents the maximum value considering all items up to item i
                # and a knapsack capacity of w. This computation ensures correctness regardless of the
                # order in which the grid is filled (column-wise or row-wise).
